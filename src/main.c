...
static void sceneRender(float size) {
  ...
  C2D_DrawText(&g_staticText[1], C2D_AtBaseline | C2D_WithColor, 16.0f, 210.0f,
               0.5f, 0.5f, 0.75f, C2D_Color32f(1.0f, 0.0f, 0.0f, 1.0f));
  C2D_DrawText(&g_staticText[2],
               C2D_AtBaseline | C2D_WithColor | C2D_AlignRight, 384.0f, 210.0f,
               0.5f, 0.75f, 0.5f, C2D_Color32f(0.0f, 0.0f, 1.0f, 0.625f));
  C2D_DrawText(&g_staticText[3],
               C2D_AtBaseline | C2D_AlignJustified | C2D_WordWrap, 100.0f,
...
int main() {
  ...
  C2D_ViewRotateDegrees(90.0f);
  C2D_ViewTranslate(0.0f, -400.0f);
  C2D_Prepare();
